        ...
        <DialogContent className="sm:max-w-md" onClick={(e) => e.stopPropagation()}>
          <DialogHeader className="text-center">
            ...
            <DialogDescription className="text-center pt-2">
              Before you mark this as Won, a congratulations is in order! 
              <br />
              <span className="font-medium text-foreground">Share your success with the team on the Wins page!</span>
            </DialogDescription>
          </DialogHeader>

  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <div className="sticky top-0 z-30 shrink-0 relative h-16 md:h-20 overflow-hidden">
        <img src={analyticsHero} alt="Reporting & Analytics Method banner" className="w-full h-full object-cover" />
        ...
        <div className="absolute inset-0 flex items-center px-6 md:px-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg md:text-xl font-bold text-secondary-foreground">Reporting & Analytics Method</h1>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-auto p-4 md:p-6">
        <div className="max-w-6xl mx-auto space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Reporting & Analytics methodology phases — items, deliverables, and tasks to be added</p>
          </div>

      ...
      <div className="sticky top-0 z-30 shrink-0 relative h-16 md:h-20 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center px-6 md:px-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg md:text-xl font-bold text-secondary-foreground">Integration Method</h1>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Integration methodology phases — items, deliverables, and tasks to be added
              </p>
            </div>
          </div>

          <Accordion type="multiple" defaultValue={integrationPhases.map(p => p.id)} className="space-y-3">

  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <div className="sticky top-0 z-30 shrink-0 relative h-16 md:h-20 overflow-hidden">
        <img src={integrationHero} alt="Current Projects banner" className="w-full h-full object-cover" />
          ...
          <Card className="bg-card w-full max-w-lg">
            <CardContent className="py-12 px-8 text-center space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                This page is currently being developed. It will integrate with external systems to display live project data.
              </p>
            </CardContent>
          </Card>
        </div>
